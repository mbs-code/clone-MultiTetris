...
void OutputBetaFunctionStr( FILE *cs, FILE *sc, FILE *def, FILE *def64, FILE *hd )
{
	...
	fprintf( cs, "\t\t\treturn Result ;\n" ) ;
	fprintf( cs, "\t\t}\n\n" ) ;
	fprintf( cs, "\t\tpublic static FLOAT2 F2Get( float u, float v )\n" ) ;
	fprintf( cs, "\t\t{\n" ) ;
	fprintf( cs, "\t\t\tFLOAT2 Result ;\n" ) ;
	fprintf( cs, "\t\t\tResult.u = u ;\n" ) ;
	fprintf( cs, "\t\t\tResult.v = v ;\n" ) ;
	fprintf( cs, "\t\t\treturn Result ;\n" ) ;
	fprintf( cs, "\t\t}\n\n" ) ;
	fprintf( cs, "\t\tpublic static FLOAT4 F4Get( float x, float y, float z, float w )\n" ) ;
	fprintf( cs, "\t\t{\n" ) ;
	fprintf( cs, "\t\t\tFLOAT4 Result ;\n" ) ;
	fprintf( cs, "\t\t\tResult.x = x ;\n" ) ;
	fprintf( cs, "\t\t\tResult.y = y ;\n" ) ;
	fprintf( cs, "\t\t\tResult.z = z ;\n" ) ;
	fprintf( cs, "\t\t\tResult.w = w ;\n" ) ;
	fprintf( cs, "\t\t\treturn Result ;\n" ) ;
	fprintf( cs, "\t\t}\n\n" ) ;
	fprintf( cs, "\t\tpublic static DOUBLE4 D4Get( double x, double y, double z, double w )\n" ) ;
	fprintf( cs, "\t\t{\n" ) ;
	fprintf( cs, "\t\t\tDOUBLE4 Result ;\n" ) ;
	fprintf( cs, "\t\t\tResult.x = x ;\n" ) ;
	fprintf( cs, "\t\t\tResult.y = y ;\n" ) ;
	fprintf( cs, "\t\t\tResult.z = z ;\n" ) ;
	fprintf( cs, "\t\t\tResult.w = w ;\n" ) ;
	...
	fprintf( cs, "\t\t\treturn Result ;\n" ) ;
	fprintf( cs, "\t\t}\n\n" ) ;
	fprintf( cs, "\t\tpublic static FLOAT2 F2Add( FLOAT2 In1, FLOAT2 In2 )\n" ) ;
	fprintf( cs, "\t\t{\n" ) ;
	fprintf( cs, "\t\t\tFLOAT2 Result ;\n" ) ;
	fprintf( cs, "\t\t\tResult.u = In1.u + In2.u ;\n" ) ;
	fprintf( cs, "\t\t\tResult.v = In1.v + In2.v ;\n" ) ;
	fprintf( cs, "\t\t\treturn Result ;\n" ) ;
	fprintf( cs, "\t\t}\n\n" ) ;
	fprintf( cs, "\t\tpublic static FLOAT4 F4Add( FLOAT4 In1, FLOAT4 In2 )\n" ) ;
	fprintf( cs, "\t\t{\n" ) ;
	fprintf( cs, "\t\t\tFLOAT4 Result ;\n" ) ;
	fprintf( cs, "\t\t\tResult.x = In1.x + In2.x ;\n" ) ;
	fprintf( cs, "\t\t\tResult.y = In1.y + In2.y ;\n" ) ;
	fprintf( cs, "\t\t\tResult.z = In1.z + In2.z ;\n" ) ;
	fprintf( cs, "\t\t\tResult.w = In1.w + In2.w ;\n" ) ;
	fprintf( cs, "\t\t\treturn Result ;\n" ) ;
	fprintf( cs, "\t\t}\n\n" ) ;
	fprintf( cs, "\t\tpublic static DOUBLE4	D4Add( DOUBLE4 In1, DOUBLE4 In2 )\n" ) ;
	fprintf( cs, "\t\t{\n" ) ;
	fprintf( cs, "\t\t\tDOUBLE4 Result ;\n" ) ;
	fprintf( cs, "\t\t\tResult.x = In1.x + In2.x ;\n" ) ;
	fprintf( cs, "\t\t\tResult.y = In1.y + In2.y ;\n" ) ;
	...
	fprintf( cs, "\t\t\treturn Result ;\n" ) ;
	fprintf( cs, "\t\t}\n\n" ) ;
	fprintf( cs, "\t\tpublic static FLOAT2 F2Sub( FLOAT2 In1, FLOAT2 In2 )\n" ) ;
	fprintf( cs, "\t\t{\n" ) ;
	fprintf( cs, "\t\t\tFLOAT2 Result ;\n" ) ;
	fprintf( cs, "\t\t\tResult.u = In1.u - In2.u ;\n" ) ;
	fprintf( cs, "\t\t\tResult.v = In1.v - In2.v ;\n" ) ;
	fprintf( cs, "\t\t\treturn Result ;\n" ) ;
	fprintf( cs, "\t\t}\n\n" ) ;
	fprintf( cs, "\t\tpublic static FLOAT4 F4Sub( FLOAT4 In1, FLOAT4 In2 )\n" ) ;
	fprintf( cs, "\t\t{\n" ) ;
	fprintf( cs, "\t\t\tFLOAT4 Result ;\n" ) ;
	fprintf( cs, "\t\t\tResult.x = In1.x - In2.x ;\n" ) ;
	fprintf( cs, "\t\t\tResult.y = In1.y - In2.y ;\n" ) ;
	...
	fprintf( cs, "\t\t\treturn Result ;\n" ) ;
	fprintf( cs, "\t\t}\n\n" ) ;
	fprintf( cs, "\t\tpublic static DOUBLE4	D4Sub( DOUBLE4 In1, DOUBLE4 In2 )\n" ) ;
	fprintf( cs, "\t\t{\n" ) ;
	fprintf( cs, "\t\t\tDOUBLE4 Result ;\n" ) ;
	fprintf( cs, "\t\t\tResult.x = In1.x - In2.x ;\n" ) ;
	fprintf( cs, "\t\t\tResult.y = In1.y - In2.y ;\n" ) ;
	...
	fprintf( cs, "\t\t\treturn Result ;\n" ) ;
	fprintf( cs, "\t\t}\n\n" ) ;
	fprintf( cs, "\t\tpublic static FLOAT2 F2Scale( FLOAT2 In, float Scale )\n" ) ;
	fprintf( cs, "\t\t{\n" ) ;
	fprintf( cs, "\t\t\tFLOAT2 Result ;\n" ) ;
	fprintf( cs, "\t\t\tResult.u = In.u * Scale ;\n" ) ;
	fprintf( cs, "\t\t\tResult.v = In.v * Scale ;\n" ) ;
	fprintf( cs, "\t\t\treturn Result ;\n" ) ;
	fprintf( cs, "\t\t}\n\n" ) ;
	fprintf( cs, "\t\tpublic static FLOAT4 F4Scale( FLOAT4 In, float Scale )\n" ) ;
	fprintf( cs, "\t\t{\n" ) ;
	fprintf( cs, "\t\t\tFLOAT4 Result ;\n" ) ;
	fprintf( cs, "\t\t\tResult.x = In.x * Scale ;\n" ) ;
	fprintf( cs, "\t\t\tResult.y = In.y * Scale ;\n" ) ;
	fprintf( cs, "\t\t\tResult.z = In.z * Scale ;\n" ) ;
	fprintf( cs, "\t\t\tResult.w = In.w * Scale ;\n" ) ;
	fprintf( cs, "\t\t\treturn Result ;\n" ) ;
	fprintf( cs, "\t\t}\n\n" ) ;
	fprintf( cs, "\t\tpublic static DOUBLE4	D4Scale( DOUBLE4 In, double Scale )\n" ) ;
	fprintf( cs, "\t\t{\n" ) ;
	fprintf( cs, "\t\t\tDOUBLE4 Result ;\n" ) ;
	fprintf( cs, "\t\t\tResult.x = In.x * Scale ;\n" ) ;
	fprintf( cs, "\t\t\tResult.y = In.y * Scale ;\n" ) ;
