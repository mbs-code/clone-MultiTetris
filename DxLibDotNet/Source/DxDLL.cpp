...
int  __stdcall dx_putsDx( const char * String, int  NewLine)
{
...
int  __stdcall dx_GetObtainsStringCharPosition( int  x, int  y, int  AddY, const char * String, int  StrLen, int *  PosX, int *  PosY, int  FontHandle)
{
	return GetObtainsStringCharPosition( x, y, AddY, String, StrLen, PosX, PosY, FontHandle);
}
int  __stdcall dx_GetObtainsStringCharPosition_CharClip( int  x, int  y, int  AddY, const char * String, int  StrLen, int *  PosX, int *  PosY, int  FontHandle)
{
...
int  __stdcall dx_LoadDivGraphF( const char * FileName, int  AllNum, int  XNum, int  YNum, float  XSize, float  YSize, int *  HandleBuf, int  NotUse3DFlag)
{
	return LoadDivGraphF( FileName, AllNum, XNum, YNum, XSize, YSize, HandleBuf, NotUse3DFlag);
}
...
int  __stdcall dx_LoadDivBmpToGraphF( const char * FileName, int  AllNum, int  XNum, int  YNum, float  SizeX, float  SizeY, int *  HandleBuf, int  TextureFlag, int  ReverseFlag)
{
	return LoadDivBmpToGraphF( FileName, AllNum, XNum, YNum, SizeX, SizeY, HandleBuf, TextureFlag, ReverseFlag);
}
...
int  __stdcall dx_LoadReverseDivGraphF( const char * FileName, int  AllNum, int  XNum, int  YNum, float  XSize, float  YSize, int *  HandleBuf, int  NotUse3DFlag)
{
	return LoadReverseDivGraphF( FileName, AllNum, XNum, YNum, XSize, YSize, HandleBuf, NotUse3DFlag);
}
...
int  __stdcall dx_CreateDivGraphFFromMem( const void * RGBFileImage, int  RGBFileImageSize, int  AllNum, int  XNum, int  YNum, float  SizeX, float  SizeY, int *  HandleBuf, int  TextureFlag, int  ReverseFlag, const void * AlphaFileImage, int  AlphaFileImageSize)
{
	return CreateDivGraphFFromMem( RGBFileImage, RGBFileImageSize, AllNum, XNum, YNum, SizeX, SizeY, HandleBuf, TextureFlag, ReverseFlag, AlphaFileImage, AlphaFileImageSize);
}
...
int  __stdcall dx_ReCreateDivGraphFFromMem( const void * RGBFileImage, int  RGBFileImageSize, int  AllNum, int  XNum, int  YNum, float  SizeX, float  SizeY, const int *  HandleBuf, int  TextureFlag, int  ReverseFlag, const void * AlphaFileImage, int  AlphaFileImageSize)
{
	return ReCreateDivGraphFFromMem( RGBFileImage, RGBFileImageSize, AllNum, XNum, YNum, SizeX, SizeY, HandleBuf, TextureFlag, ReverseFlag, AlphaFileImage, AlphaFileImageSize);
}
...
int __stdcall dx_CreateDivGraphFFromBmp( const BITMAPINFO * RGBBmpInfo , const void * RGBBmpImage , int AllNum , int XNum , int YNum , float SizeX , float SizeY , int * HandleBuf , int TextureFlag , int ReverseFlag , const BITMAPINFO * AlphaBmpInfo , const void * AlphaBmpImage ) 
{
	return CreateDivGraphFFromBmp( RGBBmpInfo , RGBBmpImage , AllNum , XNum , YNum , SizeX , SizeY , HandleBuf , TextureFlag , ReverseFlag , AlphaBmpInfo , AlphaBmpImage  ) ;
}
...
int __stdcall dx_ReCreateDivGraphFFromBmp( const BITMAPINFO * RGBBmpInfo , const void * RGBBmpImage , int AllNum , int XNum , int YNum , float SizeX , float SizeY , const int * HandleBuf , int TextureFlag , int ReverseFlag , const BITMAPINFO * AlphaBmpInfo , const void * AlphaBmpImage ) 
{
	return ReCreateDivGraphFFromBmp( RGBBmpInfo , RGBBmpImage , AllNum , XNum , YNum , SizeX , SizeY , HandleBuf , TextureFlag , ReverseFlag , AlphaBmpInfo , AlphaBmpImage  ) ;
}
...
int __stdcall dx_CreateDivGraphFFromGraphImage( BASEIMAGE * RgbBaseImage , int AllNum , int XNum , int YNum , float SizeX , float SizeY , int * HandleBuf , int TextureFlag , int ReverseFlag ) 
{
	return CreateDivGraphFFromGraphImage( RgbBaseImage , AllNum , XNum , YNum , SizeX , SizeY , HandleBuf , TextureFlag , ReverseFlag  ) ;
}
...
int __stdcall dx_CreateDivGraphFFromGraphImage_2( BASEIMAGE * RgbBaseImage , const BASEIMAGE * AlphaBaseImage , int AllNum , int XNum , int YNum , float SizeX , float SizeY , int * HandleBuf , int TextureFlag , int ReverseFlag ) 
{
	return CreateDivGraphFFromGraphImage( RgbBaseImage , AlphaBaseImage , AllNum , XNum , YNum , SizeX , SizeY , HandleBuf , TextureFlag , ReverseFlag  ) ;
}
...
int __stdcall dx_ReCreateDivGraphFFromGraphImage( BASEIMAGE * RgbBaseImage , int AllNum , int XNum , int YNum , float SizeX , float SizeY , const int * HandleBuf , int TextureFlag , int ReverseFlag ) 
{
	return ReCreateDivGraphFFromGraphImage( RgbBaseImage , AllNum , XNum , YNum , SizeX , SizeY , HandleBuf , TextureFlag , ReverseFlag  ) ;
}
...
int __stdcall dx_ReCreateDivGraphFFromGraphImage_2( BASEIMAGE * RgbBaseImage , const BASEIMAGE * AlphaBaseImage , int AllNum , int XNum , int YNum , float SizeX , float SizeY , const int * HandleBuf , int TextureFlag , int ReverseFlag ) 
{
	return ReCreateDivGraphFFromGraphImage( RgbBaseImage , AlphaBaseImage , AllNum , XNum , YNum , SizeX , SizeY , HandleBuf , TextureFlag , ReverseFlag  ) ;
}
...
int  __stdcall dx_CreateDivGraphF( int  Width, int  Height, int  Pitch, const void * RGBImage, int  AllNum, int  XNum, int  YNum, float  SizeX, float  SizeY, int *  HandleBuf, const void * AlphaImage)
{
	return CreateDivGraphF( Width, Height, Pitch, RGBImage, AllNum, XNum, YNum, SizeX, SizeY, HandleBuf, AlphaImage);
}
...
int  __stdcall dx_CreateDivGraphFFromSoftImage( int  SIHandle, int  AllNum, int  XNum, int  YNum, float  SizeX, float  SizeY, int *  HandleBuf)
{
	return CreateDivGraphFFromSoftImage( SIHandle, AllNum, XNum, YNum, SizeX, SizeY, HandleBuf);
}
...
int __stdcall dx_CreateDivGraphFFromBaseImage( BASEIMAGE * BaseImage , int AllNum , int XNum , int YNum , float SizeX , float SizeY , int * HandleBuf ) 
{
	return CreateDivGraphFFromBaseImage( BaseImage , AllNum , XNum , YNum , SizeX , SizeY , HandleBuf  ) ;
}
...
int  __stdcall dx_ReloadDivGraphF( const char * FileName, int  AllNum, int  XNum, int  YNum, float  XSize, float  YSize, const int *  HandleBuf, int  ReverseFlag)
{
	return ReloadDivGraphF( FileName, AllNum, XNum, YNum, XSize, YSize, HandleBuf, ReverseFlag);
}
...
int  __stdcall dx_ReloadReverseDivGraphF( const char * FileName, int  AllNum, int  XNum, int  YNum, float  XSize, float  YSize, const int *  HandleBuf)
{
	return ReloadReverseDivGraphF( FileName, AllNum, XNum, YNum, XSize, YSize, HandleBuf);
}
...
int  __stdcall dx_DrawRoundRectAA( float  x1, float  y1, float  x2, float  y2, float  rx, float  ry, unsigned int  Color, int  FillFlag, float  LineThickness)
{
	return DrawRoundRectAA( x1, y1, x2, y2, rx, ry, Color, FillFlag, LineThickness);
}
...
int  __stdcall dx_DrawRotaStringToZBuffer( int  x, int  y, double  ExRateX, double  ExRateY, double  RotCenterX, double  RotCenterY, double  RotAngle, int  WriteZMode, int  VerticalFlag, const char * String)
{
...
int  __stdcall dx_DrawRotaStringToHandleToZBuffer( int  x, int  y, double  ExRateX, double  ExRateY, double  RotCenterX, double  RotCenterY, double  RotAngle, int  FontHandle, int  WriteZMode, int  VerticalFlag, const char * String)
{
...
int  __stdcall dx_MV1AddLoadModelDisablePhysicsNameWord( const char * NameWord)
{
...
int  __stdcall dx_LoadDivGraphFToResource( int  ResourceID, int  AllNum, int  XNum, int  YNum, float  XSize, float  YSize, int *  HandleBuf)
{
	return LoadDivGraphFToResource( ResourceID, AllNum, XNum, YNum, XSize, YSize, HandleBuf);
}
...
int  __stdcall dx_LoadDivGraphFToResource_2( const char * ResourceName, const char * ResourceType, int  AllNum, int  XNum, int  YNum, float  XSize, float  YSize, int *  HandleBuf)
{
	return LoadDivGraphFToResource( ResourceName, ResourceType, AllNum, XNum, YNum, XSize, YSize, HandleBuf);
}
