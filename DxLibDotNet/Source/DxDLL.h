...
int  __stdcall dx_putsDx( const char * String, int  NewLine = TRUE);
...
int  __stdcall dx_GetObtainsStringCharPosition( int  x, int  y, int  AddY, const char * String, int  StrLen, int *  PosX, int *  PosY, int  FontHandle = -1);
int  __stdcall dx_GetObtainsStringCharPosition_CharClip( int  x, int  y, int  AddY, const char * String, int  StrLen, int *  PosX, int *  PosY, int  FontHandle = -1);
...
int  __stdcall dx_LoadDivGraphF( const char * FileName, int  AllNum, int  XNum, int  YNum, float  XSize, float  YSize, int *  HandleBuf, int  NotUse3DFlag = FALSE);
...
int  __stdcall dx_LoadReverseDivGraphF( const char * FileName, int  AllNum, int  XNum, int  YNum, float  XSize, float  YSize, int *  HandleBuf, int  NotUse3DFlag = FALSE);
...
int  __stdcall dx_CreateDivGraphFFromMem( const void * RGBFileImage, int  RGBFileImageSize, int  AllNum, int  XNum, int  YNum, float  SizeX, float  SizeY, int *  HandleBuf, int  TextureFlag = TRUE, int  ReverseFlag = FALSE, const void * AlphaFileImage = NULL, int  AlphaFileImageSize = 0);
...
int  __stdcall dx_ReCreateDivGraphFFromMem( const void * RGBFileImage, int  RGBFileImageSize, int  AllNum, int  XNum, int  YNum, float  SizeX, float  SizeY, const int *  HandleBuf, int  TextureFlag = TRUE, int  ReverseFlag = FALSE, const void * AlphaFileImage = NULL, int  AlphaFileImageSize = 0);
...
int __stdcall dx_CreateDivGraphFFromBmp( const BITMAPINFO * RGBBmpInfo , const void * RGBBmpImage , int AllNum , int XNum , int YNum , float SizeX , float SizeY , int * HandleBuf , int TextureFlag = TRUE , int ReverseFlag = FALSE , const BITMAPINFO * AlphaBmpInfo = NULL , const void * AlphaBmpImage = NULL ) ;
...
int __stdcall dx_ReCreateDivGraphFFromBmp( const BITMAPINFO * RGBBmpInfo , const void * RGBBmpImage , int AllNum , int XNum , int YNum , float SizeX , float SizeY , const int * HandleBuf , int TextureFlag = TRUE , int ReverseFlag = FALSE , const BITMAPINFO * AlphaBmpInfo = NULL , const void * AlphaBmpImage = NULL ) ;
...
int __stdcall dx_CreateDivGraphFFromGraphImage( BASEIMAGE * RgbBaseImage , int AllNum , int XNum , int YNum , float SizeX , float SizeY , int * HandleBuf , int TextureFlag = TRUE , int ReverseFlag = FALSE ) ;
...
int __stdcall dx_CreateDivGraphFFromGraphImage_2( BASEIMAGE * RgbBaseImage , const BASEIMAGE * AlphaBaseImage , int AllNum , int XNum , int YNum , float SizeX , float SizeY , int * HandleBuf , int TextureFlag = TRUE , int ReverseFlag = FALSE ) ;
...
int __stdcall dx_ReCreateDivGraphFFromGraphImage( BASEIMAGE * RgbBaseImage , int AllNum , int XNum , int YNum , float SizeX , float SizeY , const int * HandleBuf , int TextureFlag = TRUE , int ReverseFlag = FALSE ) ;
...
int __stdcall dx_ReCreateDivGraphFFromGraphImage_2( BASEIMAGE * RgbBaseImage , const BASEIMAGE * AlphaBaseImage , int AllNum , int XNum , int YNum , float SizeX , float SizeY , const int * HandleBuf , int TextureFlag = TRUE , int ReverseFlag = FALSE ) ;
...
int  __stdcall dx_CreateDivGraphF( int  Width, int  Height, int  Pitch, const void * RGBImage, int  AllNum, int  XNum, int  YNum, float  SizeX, float  SizeY, int *  HandleBuf, const void * AlphaImage = NULL);
...
int  __stdcall dx_ReloadDivGraphF( const char * FileName, int  AllNum, int  XNum, int  YNum, float  XSize, float  YSize, const int *  HandleBuf, int  ReverseFlag = FALSE);
...
int  __stdcall dx_DrawCircleAA( float  x, float  y, float  r, int  posnum, unsigned int  Color, int  FillFlag = TRUE, float  LineThickness = 1);
int  __stdcall dx_DrawOval( int  x, int  y, int  rx, int  ry, unsigned int  Color, int  FillFlag, int  LineThickness = 1);
int  __stdcall dx_DrawOvalAA( float  x, float  y, float  rx, float  ry, int  posnum, unsigned int  Color, int  FillFlag, float  LineThickness = 1);
...
int  __stdcall dx_DrawRoundRectAA( float  x1, float  y1, float  x2, float  y2, float  rx, float  ry, unsigned int  Color, int  FillFlag, float  LineThickness = 1.0f);
